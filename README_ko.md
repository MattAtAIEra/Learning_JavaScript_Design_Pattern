...
block-beta
  ...
  block:map["00 아키텍트의 의사결정 흐름 — 여기서 시작"]
    columns 1
  end

  space

  block:foundation["기초 레이어 (순서 무관)"]
    columns 5
    s01["01\n모듈 &\n네임스페이스"]
    s02["02\n객체 생성\nFactory · Builder\nSingleton"]
    s03["03\n공유 유틸리티\n& 함수형 코어"]
  ...
  block:keystone["06 의존성 주입 & IoC 컨테이너 — 핵심: 01‑05를 연결"]
    columns 1
  end

  space

  block:application["애플리케이션 레이어 (순서 무관)"]
    columns 5
    s07["07\n컴포넌트\n간 통신"]
    s08["08\n상태 &\n비즈니스 로직"]
    s09["09\nMVC / MVP\nMVVM"]
  ...
  block:capstone["12 팀 & 프레임워크 통합 — 마무리"]
    columns 1
  end
